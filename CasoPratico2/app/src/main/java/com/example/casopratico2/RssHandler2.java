...
public class RssHandler2 extends DefaultHandler implements LexicalHandler {
    ...
    private static final String AUTORITIES = "publico.pt";
    Uri uri = Uri.parse("content://"+ AUTORITIES + "/" + FeedsDB.Posts.NOME_TABELA_2);
    public RssHandler2(ContentResolver contentResolver){

...
public class RssHandler3 extends DefaultHandler implements LexicalHandler {
    ...
    private static final String AUTORITIES = "tsf.pt";
    Uri uri = Uri.parse("content://"+ AUTORITIES + "/" + FeedsDB.Posts.NOME_TABELA_3);
    public RssHandler3(ContentResolver contentResolver){

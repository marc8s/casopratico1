...
public class FeedsSQLHelper3 extends SQLiteOpenHelper {

    //construtor
    public FeedsSQLHelper3(Context context){
        super(context, FeedsDB.DB_NAME_3, null, FeedsDB.DB_VERSION_3);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + FeedsDB.Posts.NOME_TABELA_3 + "("

...
public class FeedsProvider extends ContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://blog.masterd.pt");
    ...
    static {
        ...
        uriMatcher.addURI("blog.masterd.pt", "post", POST);
        uriMatcher.addURI("blog.masterd.pt", "post/#", POST_ID);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
       long rowID = feedsDB.replace(FeedsDB.Posts.NOME_TABELA, "", values);
       if(rowID>0){
           Uri baseUri = Uri.parse("content://blog.masterd.pt/post");
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (uriMatcher.match(uri)){
            case POST:
                count = feedsDB.delete(FeedsDB.Posts.NOME_TABELA, where, whereArgs);
                break;
            case POST_ID:
                String id = uri.getPathSegments().get(1);
                count = feedsDB.delete(FeedsDB.Posts.NOME_TABELA, FeedsDB.Posts._ID
                + " = "
                + id
    ...
    public int update( Uri uri,  ContentValues values,  String selection,  String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            case POST:
                count = feedsDB.update(FeedsDB.Posts.NOME_TABELA, values, selection, selectionArgs);
                break;
            case POST_ID:
                count = feedsDB.update(FeedsDB.Posts.NOME_TABELA, values, FeedsDB.Posts._ID
                + " = "
    ...
    public Cursor query(Uri uri,  String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        sqlBuilder.setTables(FeedsDB.Posts.NOME_TABELA);
